...
<form action="" method="POST" style="text-align: center; margin-bottom: 10px;">
    <table>
        <tr><th colspan="5">Filtros de Cotizaciones</th></tr>
        <tr>
            <td align="left">
                <label>Fecha Inicial:<br>
                      <input type="date" name="start_date" value="<?= htmlspecialchars($start_date) ?>"></label><br>
                <label>Fecha Final:<br>
                      <input type="date" name="end_date" value="<?= htmlspecialchars($end_date) ?>"></label>
            </td>
            <td>
            ...
            <td align="left" style="text-align: left">
                        ...
                        <input align="left" type="checkbox" name="excluir_op_gd" value="1" <?= $excluir_op_gd ? 'checked' : '' ?>>
                        Excluir OC/GD/GR y Reemplazada
                     <br>
                 <span style="text-align: left">
                         <input align="left" type="checkbox" name="excluir_op_perdida" value="1" <?= $excluir_op_perdida ? 'checked' : '' ?>> Excluye OP Perdida
                  </span>  
            </td>
            <td>
...
<?php if (!empty($quotes)): ?>
    <table style="margin: 0 auto; border-collapse: collapse; width: 90%; text-align: center; border: 1px solid #ddd;">
        <tr>
            <td colspan="10">Tabla Principal de Cotizaciones</td>
        </tr>
...
<table style="margin: 0 auto; border-collapse: collapse; width: 60%; text-align: center; border: 1px solid #ddd;">
    <tr>
        <td colspan="5">Tabla Resumen de Cotizaciones por Estado</td>
    </tr>
   <tr style="background-color: #f2f2f2;">
        <th>Estado</th>
        <th>Cantidad</th>
