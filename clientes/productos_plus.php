<?php
	...
	$objGrid-> addButton("images/user.png", "productos()", "Clientes");
...
//////////////////////////////////////////////////////////////////////////
	...
	$objGrid -> FormatColumn("producto", "Producto",  25, 25, 0, "100", "center", "select:ADSL_ADSL:Enlace Dedicado_Enlace Dedicado:Punto a Punto_Punto a Punto:Router_Router:CCTV_CCTV:Telefonia IP_Telefonia IP:Hosting_Hosting:Soporte_Soporte:Cloud_Cloud:VPN_VPN:PACK IP_PACK IP:VPS_VPS:Colocate_Colocate:DID Adicional_DID Adicional:Equipo en Comodato_Equipo en Comodato:Equipo en Arriendo_Equipo en Arriendo:MPLS_MPLS:Reseller_Reseller:Canje_Canje:Gasto_Gasto:SMS_SMS", "Enlace Dedicado");
