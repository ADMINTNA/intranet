...
if (isset($_GET['codserv'])) { $codserv = $_GET['codserv']; }
if (empty($codserv)) exit();
$ptr        = 0;
$datos      = array();
$id         = "";
$no_mostrar = 0;
...
$result = $conn->query($sql);
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if (!$no_mostrar) {
        /*    $datos_completos .= "<td ".$style.">".$ptr.".- <a href='".$url_empresa.$row["id"]."' target=\"_blank\">".$row["razon_social"]."</a><br>".$row["tamano_empresa"].
            "&nbsp;&nbsp;&nbsp;&nbsp;- <a href='".$url_rut."' target=\"_blank\">".$row["rut"]."</a>".
            "</td>";
        */
