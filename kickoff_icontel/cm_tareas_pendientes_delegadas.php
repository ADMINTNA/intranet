...
// /intranet/kickoff_icontel/cm_tareas_pendientes_delegadas.php
...
<tr class="subtit">
    ...
    <th class="subtitulo" style="white-space:nowrap">
        Asunto&nbsp;<input id="filtro-del-asunto"
            type="text" placeholder="🔍"
            oninput="delFilterAsunto(this.value)"
            ...
            id="filtro-del-asunto-x"
            onclick="document.getElementById('filtro-del-asunto').value='';delFilterAsunto('')"
            title="Quitar filtro"
...
<script>
function delFilterAsunto(q){
    q=q.toLowerCase();
    var x=document.getElementById('filtro-del-asunto-x');
