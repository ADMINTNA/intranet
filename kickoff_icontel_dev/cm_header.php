...
// Admin groups for permission checks
$admin = "/ -..MAM / -..MAO ";
...
function abrirBetaKickoff() {
    ...
    let nueva = window.open(
        "https://intranet.icontel.cl/kickoff_icontel/icontel.php",
        "_blank",
        "noopener"
    );
...
<td align="right" style="cursor: pointer;" onclick="window.top.location.href='https://intranet.icontel.cl/index.php'" title="Ir al Inicio (Cierra Sesión)">
            ...
            <tr style="background-color:#1F1D3E;color:white;">
              ...
              <td align="center">
                <?php if (strpos($admin, $sg_name) !== false): ?>
                  <p class="botonheader2"><a href="/reconciliacion_facturacion/" target="_blank" style="color: inherit; text-decoration: none;"><b>Conciliación</b></a></p>
                <?php else: ?>
                  <p class="botonheader2">&nbsp;</p>
                <?php endif; ?>
              </td>
              ...
              <td colspan="1" width="11%" align="right">
