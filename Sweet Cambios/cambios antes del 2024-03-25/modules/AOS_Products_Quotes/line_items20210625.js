...
function insertProductLine(tableid, groupid) {
  ...
  c.innerHTML = "<input type='text' name='product_product_list_price[" + prodln + "]' id='product_product_list_price" + prodln + "' maxlength='50' value='' title='' tabindex='116' onblur='calculateLine(" + prodln + ",\"product_\");' class='product_list_price'>"

  var c2 = x.insertCell(5);
  c2.innerHTML="<input type='text' name='product_product_cost_price[" + prodln + "]' id='product_product_cost_price" + prodln + "' value=''>";
...
// linea de Descripción y nota ---------------------------
  ...
  h1.innerHTML += "<textarea tabindex='116' name='product_item_description[" + prodln + "]' id='product_item_description" + prodln + "' rows='4' cols='23' class='product_item_description'></textarea>&nbsp;&nbsp;";
  ...
  i.innerHTML += "<textarea tabindex='116' name='product_description[" + prodln + "]' id='product_description" + prodln + "' rows='4' cols='23' class='product_description'></textarea>&nbsp;&nbsp;"
// FIN linea de Descripción y nota ---------------------------
 ...
 // linea de Proveedor, vigencia y fecha contrato  ---------------------------
  ...
  h2w.innerHTML+= "<input autocomplete='on' type='text' name='product_duracion_contrato[" + prodln + "]' id='product_duracion_contrato" + prodln + "' />";
...
// aqui va fecha contrato    
  ...
  h3w.innerHTML = "<span style='vertical-align: top;' class='product_item_description_label'> Fecha Contrato (dd/mm/aaaa) :&nbsp;&nbsp;</span>";
  ...
  h3w.innerHTML += "<input type='text' name='product_fecha_contrato[" + prodln + "]' id='product_fecha_contrato" + prodln + "' class='date_input'>";

  h3w.innerHTML+= fin_grupo;
 // FIN linea de Proveedor, vigencia y fecha contrato  ---------------------------
