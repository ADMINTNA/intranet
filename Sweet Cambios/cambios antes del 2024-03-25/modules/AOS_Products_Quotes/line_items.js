...
function insertLineItems(product, group) {
  ...
  if (product.product_id != "0" && product.product_id !== "") {
    insertProductHeader("product_group" + current_group);
...
function insertProductLine(tableid, groupid) {
  ...
  // console.log(x);
  // x.style.padding = "10px 5px";
  x.id = "product_line" + prodln;

  var a = x.insertCell(0);
  a.innerHTML =
    "<input type='text' name='product_product_qty[" +
    prodln +
  ...
  b.innerHTML =
    "<input class='sqsEnabled product_name' autocomplete='off' type='text' name='product_name[" +
    prodln +
    "]' id='product_name" +
    prodln +
  ...
  b1.innerHTML =
    "<input class='sqsEnabled product_part_number' autocomplete='off' type='text' name='product_part_number[" +
    prodln +
  ...
  c.innerHTML =
    "<input type='text' name='product_product_list_price[" +
    prodln +
    "]' id='product_product_list_price" +
    prodln +
    "' maxlength='50' value='' title='' tabindex='116' onblur='calculateLine(" +
    prodln +
    ",\"product_\");' class='product_list_price'>";

  var c2 = x.insertCell(5);
  c2.innerHTML =
    "<input type='text' name='product_product_cost_price[" +
    prodln +
  ...
  d.innerHTML =
    "<input type='text' name='product_product_discount[" +
    prodln +
    ...
    "' value=''  />";
  d.innerHTML +=
    "<select tabindex='116' name='product_discount[" +
    prodln +
    "]' id='product_discount" +
    prodln +
  ...
  e.innerHTML =
    "<input type='text' name='product_product_unit_price[" +
    prodln +
  ...
  /*f.innerHTML = "<input type='text' name='product_fecha_contrato[" + prodln + "]' id='product_fecha_contrato" + prodln + "' value=''  />";*/
  f.innerHTML =
    "<input type='hidden' name='product_vat_amt[" +
    prodln +
    "]' id='product_vat_amt" +
    prodln +
    "' maxlength='250' value='' title='' tabindex='116' readonly='readonly' class='product_vat_amt_text'>";
  f.innerHTML +=
    "<select tabindex='116' name='product_vat[" +
    prodln +
    "]' id='product_vat" +
    prodln +
    "' onchange='calculateLine(" +
  ...
  g.innerHTML =
    "<input type='text' name='product_product_total_price[" +
    prodln +
  ...
  //9-6-2021 mAo: se define linea separadora de producto.
  var fin_grupo =
    "<hr style='height:1px;border-width:0;background-color:dimgray'>";
 

  // linea de Descripción y nota ---------------------------
  ...
  h1.innerHTML =
    "<span style='vertical-align: top;' class='product_item_description_label'>" +
    SUGAR.language.get(module_sugar_grp1, "LBL_PRODUCT_DESCRIPTION") +
    " :&nbsp;&nbsp;</span>";
  h1.innerHTML +=
    "<textarea tabindex='116' name='product_item_description[" +
    prodln +
    "]' id='product_item_description" +
    prodln +
    "' rows='4' cols='23' class='product_item_description'></textarea>&nbsp;&nbsp;";

  var i = y.insertCell(1);
  i.colSpan = "6";
  i.style.color = "rgb(68,68,68)";
// mAo 4-2-2022 cambio etiqueta Notas: por Dirección de Instalación
  // i.innerHTML =
  ...
  i.innerHTML =
    "<span style='vertical-align: top;' class='product_description_label'>" +
    "Detalles de instalación (dirección, dominio, DID):" +
    " :&nbsp;</span>"; 
    
  i.innerHTML +=
    "<textarea tabindex='116' name='product_description[" +
    prodln +
    "]' id='product_description" +
    prodln +
    "' rows='4' cols='23' class='product_description'></textarea>&nbsp;&nbsp;";
  // FIN linea de Descripción y nota ---------------------------

  // mAo linea de Proveedor, codigo de servicio, vigencia y fecha contrato  ---------------------------

  var w = tablebody.insertRow(-1);
  w.id = "product_custom_line" + prodln;
  var h1w = w.insertCell(0);
  h1w.colSpan = "2";
  h1w.style.color = "rgb(68,68,68)";
  h1w.innerHTML =
    "<span style='vertical-align: top;' class='product_item_description_label'> Proveedor :&nbsp;&nbsp;</span>";
  h1w.innerHTML +=
    "<input class='sqsEnabled product_name' autocomplete='on' type='text' name='product_account_name[" +
    prodln +
    "]' id='product_account_name" +
    prodln +
    "' value='' title=''><input type='hidden' name='product_account_id_c[" +
    prodln +
    "]' id='product_account_id_c" +
    prodln +
    "'  maxlength='50' value=''>";
  h1w.innerHTML += fin_grupo;

  var b3 = w.insertCell(1);
  b3.innerHTML =
    "<span style='vertical-align: top;' class='product_item_description_label'>&nbsp;&nbsp;</span>";
  b3.innerHTML +=
    "<button title='" +
    SUGAR.language.get("app_strings", "LBL_SELECT_BUTTON_TITLE") +
    "' accessKey='" +
    SUGAR.language.get("app_strings", "LBL_SELECT_BUTTON_KEY") +
    "' type='button' class='button product_part_number_button' value='" +
    SUGAR.language.get("app_strings", "LBL_SELECT_BUTTON_LABEL") +
    "' name='btn3' onclick='openProviderPopup(" +
    prodln +
    ');\'><span class="suitepicon suitepicon-action-select"></span></button>';
  b3.innerHTML += fin_grupo;
 
  var h4w = w.insertCell(2);
  h4w.colSpan = "4";
  h4w.style.color = "rgb(68,68,68)";
  h4w.innerHTML =
    "<span style='vertical-align: top;' class='product_item_description_label'> Codígo Servicio:</span>";
  h4w.innerHTML +=
    "<input  type='text' name='product_codigo_servicio[" +
    prodln +
    "]' id='product_codigo_servicio" +
    prodln +
    "' />";
    h4w.innerHTML += fin_grupo;

      
  var h2w = w.insertCell(3);
  h2w.colSpan = "2";
  h2w.style.color = "rgb(68,68,68)";
  h2w.innerHTML =
    "<span style='vertical-align: top;' class='product_item_description_label'> Vigencia :&nbsp;&nbsp;</span>";
   h2w.innerHTML +=
    "<input autocomplete='on' type='text' name='product_duracion_contrato[" +
    prodln +
    "]' id='product_duracion_contrato" +
    prodln +
    "' />";
  h2w.innerHTML += fin_grupo;

  // aqui va fecha contrato

  var h3w = w.insertCell(4);
  h3w.colSpan = "2";
  h3w.style.color = "rgb(68,68,68)";
  h3w.innerHTML =
    "<span style='vertical-align: top;' class='product_item_description_label'> Fecha Contrato (dd/mm/aaaa) :&nbsp;&nbsp;</span>";
  h3w.innerHTML +=
    "<input type='text' name='product_fecha_contrato[" +
    prodln +
    "]' id='product_fecha_contrato" +
    prodln +
    "' class='date_input'>";

  h3w.innerHTML += fin_grupo;
  // FIN linea de Proveedor, codigo de servicio , vigencia y fecha contrato  ---------------------------

  const date = document.getElementById("product_fecha_contrato" + prodln);
  console.log(date);
  if (!date.value) {
    const d = new Date();
    date.value = `${d.getDate()}/${d.getMonth() + 1}/${d.getFullYear()}`;
  }
  //h3w.innerHTML += `<button type="button" id="vigencia_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="Enter Date"></span></button></span>`;
  /*h3w.innerHTML += `<script type="text/javascript">
Calendar.setup ({
inputField : "product_fecha_contrato${prodln}",
form : "EditView",
ifFormat : "%m/%d/%Y %H:%M",
daFormat : "%m/%d/%Y %H:%M",
button : "vigencia_trigger",
singleClick : true,
dateStr : "07/02/2021",
startWeekday: 0,
step : 1,
weekNumbers:false
  ...
  // document.getElementById(`product_fecha_contrato[${prodln}]`).value = new Date().toISOString().substring(0, 10);
  /*h3w.innerHTML +=`<button type="button" id="vigencia_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="Enter Date"></span></button>
  </span>
 ...
 * Open provider popup
 */
function openProviderPopup(ln) {
  lineno = ln;
  var popupRequestData = {
    call_back_function: "setProductReturn2",
    form_name: "EditView",
    field_to_name_array: {
      id: "product_account_id_c" + ln,
      name: "product_account_name" + ln,
    },
  };
...
function setProductReturn2(popupReplyData2) {
  set_return(popupReplyData2);
}
...
function formatListPrice(ln) {
  if (typeof currencyFields !== "undefined") {
    var product_currency_id = document.getElementById(
      "product_currency" + ln
    ).value;
    ...
    var dollar_product_price = ConvertToDollar(
      document.getElementById("product_product_list_price" + ln).value,
      product_currency_rate
    );
    document.getElementById("product_product_list_price" + ln).value =
      format2Number(ConvertFromDollar(dollar_product_price, lastRate));
    var dollar_product_cost = ConvertToDollar(
      document.getElementById("product_product_cost_price" + ln).value,
      product_currency_rate
    );
    document.getElementById("product_product_cost_price" + ln).value =
      format2Number(ConvertFromDollar(dollar_product_cost, lastRate));
  } else {
    document.getElementById("product_product_list_price" + ln).value =
      format2Number(
        document.getElementById("product_product_list_price" + ln).value
...
function insertServiceLine(tableid, groupid) {
  ...
  a.colSpan = "4";
  a.innerHTML =
    "<textarea name='service_name[" +
    servln +
    "]' id='service_name" +
    servln +
    "'  cols='64' title='' tabindex='116' class='service_name'></textarea><input type='hidden' name='service_product_id[" +
    servln +
  ...
  a1.innerHTML =
    "<input type='text' name='service_product_list_price[" +
    servln +
    "]' id='service_product_list_price" +
    servln +
    "' maxlength='50' value='' title='' tabindex='116'   onblur='calculateLine(" +
    servln +
    ",\"service_\");' class='service_list_price'>";
  ...
  a2.innerHTML =
    ...
    servln +
    "]' id='service_product_discount" +
    servln +
    "'  maxlength='50' value='' title='' tabindex='116' onblur='calculateLine(" +
    servln +
    ",\"service_\");' onblur='calculateLine(" +
    servln +
    ",\"service_\");' class='service_discount_text'><input type='hidden' name='service_product_discount_amount[" +
    servln +
    "]' id='service_product_discount_amount" +
    servln +
    "' value=''/>";
  a2.innerHTML +=
    "<select tabindex='116' name='service_discount[" +
    servln +
    "]' id='service_discount" +
    servln +
    "' onchange='calculateLine(" +
    servln +
    ",\"service_\");' class='service_discount_select'>" +
    discount_hidden +
    "</select>";

  var b = x.insertCell(3);
  b.innerHTML =
    "<input type='text' name='service_product_unit_price[" +
    servln +
    "]' id='service_product_unit_price" +
    servln +
    "' maxlength='50' value='' title='' tabindex='116'   onblur='calculateLine(" +
    servln +
    ",\"service_\");' class='service_unit_price'>";
  ...
  var c = x.insertCell(4);
  c.innerHTML =
    "<input type='text' name='service_vat_amt[" +
    servln +
    "]' id='service_vat_amt" +
    servln +
    "' maxlength='250' value='' title='' tabindex='116' readonly='readonly' class='service_vat_text'>";
  c.innerHTML +=
    "<select tabindex='116' name='service_vat[" +
    servln +
    "]' id='service_vat" +
    servln +
    "' onchange='calculateLine(" +
    servln +
    ",\"service_\");' class='service_vat_select'>" +
    vat_hidden +
    "</select>";
  if (typeof currencyFields !== "undefined") {
  ...
  e.innerHTML =
    "<input type='text' name='service_product_total_price[" +
    servln +
    "]' id='service_product_total_price" +
    servln +
    "' maxlength='50' value='' title='' tabindex='116' readonly='readonly' class='service_total_price'><input type='hidden' name='service_group_number[" +
    servln +
    "]' id='service_group_number" +
    servln +
    "' value='" +
    groupid +
    "'>";
  ...
  f.innerHTML =
    ...
    "]' id='service_deleted" +
    servln +
    "' value='0'><input type='hidden' name='service_id[" +
    servln +
    "]' id='service_id" +
    servln +
    "' value=''><button type='button' class='button service_delete_line' id='service_delete_line" +
    servln +
    "' value='" +
    SUGAR.language.get(module_sugar_grp1, "LBL_REMOVE_PRODUCT_LINE") +
    "' tabindex='116' onclick='markLineDeleted(" +
    servln +
    ',"service_")\'><span class="suitepicon suitepicon-action-clear"></span></button><br>';
...
function insert(table_id, group) {
  insertProductHeader(table_id);
  insertProductLine(table_id, group);
}
/**
 * Insert Group
 */
...
function insertGroup() {
  ...
  footer_cell.innerHTML =
    ...
    "' id='" +
    productTable.id +
    "addProductLine' onclick='insert(\"" +
    productTable.id +
    '","' +
    groupn +
    "\")' />";
  footer_cell.innerHTML +=
    " <input type='button' tabindex='116' class='button add_service_line' value='" +
    SUGAR.language.get(module_sugar_grp1, "LBL_ADD_SERVICE_LINE") +
    "' id='" +
    serviceTable.id +
    "addServiceLine' onclick='insertServiceLine(\"" +
    serviceTable.id +
    '","' +
    groupn +
    "\")' />";
  if (enable_groups) {
    footer_cell.innerHTML +=
      ...
      ":</label><input name='group_total_amt[]' id='" +
      table.id +
      "total_amt' class='group_total_amt' maxlength='26' value='' title='' tabindex='120' type='text' readonly></span>";
    ...
    footer_cell2.innerHTML =
      ...
      ":</label><input name='group_discount_amount[]' id='" +
      table.id +
      "discount_amount' class='group_discount_amount' maxlength='26' value='' title='' tabindex='120' type='text' readonly></label>";
    ...
    footer_cell3.innerHTML =
      ...
      ":</label><input name='group_subtotal_amount[]' id='" +
      table.id +
      "subtotal_amount' class='group_subtotal_amount'  maxlength='26' value='' title='' tabindex='120' type='text' readonly></span>";
    ...
    footer_cell4.innerHTML =
      ...
      ":</label><input name='group_tax_amount[]' id='" +
      table.id +
      "tax_amount' class='group_tax_amount' maxlength='26' value='' title='' tabindex='120' type='text' readonly></span>";
    ...
    if (document.getElementById("subtotal_tax_amount") !== null) {
      ...
      footer_cell5.innerHTML =
        ...
        ":</label><input name='group_subtotal_tax_amount[]' id='" +
        table.id +
        "subtotal_tax_amount' class='group_subtotal_tax_amount' maxlength='26' value='' title='' tabindex='120' type='text' readonly></span>";
    ...
    footer_cell6.innerHTML =
      ...
      ":</label><input name='group_total_amount[]' id='" +
      table.id +
      "total_amount' class='group_total_amount'  maxlength='26' value='' title='' tabindex='120' type='text' readonly></span>";
...
function calculateLine(ln, key) {
  //console.log(`CALCULATE LN ${ln} key ${key}`);
  ...
  if (
    document.getElementById(key + "name" + ln).value === "" ||
...
function calculateAllLines() {
  ...
  $(".service_group").each(function (serviceGroupkey, serviceGroupValue) {
    $(serviceGroupValue)
      .find("tbody")
      .each(function (serviceKey, serviceValue) {
