/**
 * 3-6-2021 MaO recordar que los campos agregados están en la tabla aos_products_quotes_cstm
 *
...
function insertProductLine(tableid, groupid) {
  ...
  c2.innerHTML="<input type='text' name='product_product_cost_price[" + prodln + "]' id='product_product_cost_price" + prodln + "' >";
  ...
  f.innerHTML = "<input type='hidden' name='product_vat_amt[" + prodln + "]' id='product_vat_amt" + prodln + "' maxlength='250' value='' title='' tabindex='116' readonly='readonly' class='product_vat_amt_text'>";
  ...
  g.innerHTML = "<input type='text' name='product_product_total_price[" + prodln + "]' id='product_product_total_price" + prodln + "' maxlength='50' value='' title='' tabindex='116' readonly='readonly' class='product_total_price'><input type='hidden' name='product_group0_number[" + prodln + "]' id='product_group_number" + prodln + "' value='"+groupid+"'>";
  ...
  h1.innerHTML += "<textarea tabindex='116' name='product_item_description[" + prodln + "]' id='product_item_description" + prodln + "' rows='2' cols='23' class='product_description'></textarea>&nbsp;&nbsp;"
  ...
  var fin_grupo ="<hr style='height:1px;border-width:0;background-color:LightBlue'>";
  ...
  h1w.innerHTML = "<span style='vertical-align: top;' class='product_item_description_label'> Proveedor :&nbsp;&nbsp;</span>";
  h1w.innerHTML += "<input class='sqsEnabled product_name' autocomplete='on' type='text' name='product_account_name[" + prodln + "]' id='product_account_name" + prodln + "' value='' title=''><input type='hidden' name='product_account_id_c[" + prodln + "]' id='product_account_id_c" + prodln + "'  maxlength='50' value=''>" ;
  h1w.innerHTML+= fin_grupo;
 
    
  var b3= w.insertCell(1);
  b3.innerHTML = "<span style='vertical-align: top;' class='product_item_description_label'>&nbsp;&nbsp;</span>";
  b3.innerHTML += "<button title='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_TITLE') + "' accessKey='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_KEY') + "' type='button' class='button product_part_number_button' value='" + SUGAR.language.get('app_strings', 'LBL_SELECT_BUTTON_LABEL') + "' name='btn3' onclick='openProviderPopup(" + prodln + ");'><span class=\"suitepicon suitepicon-action-select\"></span></button>" ;
  b3.innerHTML += fin_grupo;
    
  var h2w = w.insertCell(2);
  h2w.colSpan ="2";
  h2w.style.color="rgb(68,68,68)";
  h2w.innerHTML = "<span style='vertical-align: top;' class='product_item_description_label'>&nbsp;&nbsp;Vigencia :&nbsp;&nbsp;</span>";
  //h2w.innerHTML += "<input class='sqsEnabled product_name' autocomplete='off' type='text' name='product_name[" + prodln + "]' id='product_name" + prodln + "' value='' title=''>";
  h2w.innerHTML+= "<input  type='text' name='product_duracion_contrato[" + prodln + "]' id='product_duracion_contrato" + prodln + "' />" ;
  h2w.innerHTML+= fin_grupo;
    
  var h3w = w.insertCell(3);
  var linea = "<hr style=\"height:1px;border-width:0;color:gray;background-color:gray\">";    
  h3w.colSpan ="3";
  h3w.style.color ="rgb(68,68,68)";
  h3w.innerHTML = "<span style='vertical-align: top;' class='product_item_description_label'>dd/mm/aaaa Contrato :&nbsp;&nbsp;</span>";
  // h3w.innerHTML += "<input type='text' name='product_fecha_contrato_c[" + prodln + "]' id='product_fecha_contrato_c" + prodln + "' /> " + fin_grupo;
 // <<<< h3w.innerHTML += "<input type='text' name='product_fecha_contrato" + prodln + "' id='product_fecha_contrato_c" + prodln + "' /> ";
   h3w.innerHTML += "<input class='date_input' autocomplete='off' type='text' name='product_fecha_contrato[" + prodln + "]' id='product_fecha_contrato" + prodln + "' /> ";
  // h3w.innerHTML += "<script type='text/javascript'>Calendar.setup ({inputField : 'product_fecha_contrato_c" + prodln + "',form : 'EditView',ifFormat : '%d-%m-%Y %H:%M',daFormat : '%d-%m-%Y %H:%M',button : 'product_fecha_contrato_c" + prodln + "_trigger',singleClick : true,dateStr : '31-08-2015',startWeekday: 0,step : 1,weekNumbers:false});</script>";
  // h3w.innerHTML += "<input class='date_input' autocomplete='off' type='text' name='product_fecha_contrato_c" + prodln + "' id='product_fecha_contrato_c" + prodln + "' /> ";
  // h3w.innerHTML += "<button type='button' id='product_fecha_contrato_c" + prodln + "_trigger' class='btn btn-danger' onclick='return false;'><span class='suitepicon suitepicon-module-calendar' alt='Introducir Fecha'></span></button>";
  
  h3w.innerHTML += fin_grupo;
  // h3w.innerHTML += "<input type='date' name='product_fecha_contrato_c[" + prodln + "]' id='product_fecha_contrato_c" + prodln + "' /> " + fin_grupo; // Miguel Quila (cambia el tipo de input de text a date para que el navegador muestre un seleccionador de fecha)

  //h3w.innerHTML += "<input class='sqsEnabled product_name' autocomplete='off' type='text' name='product_name[" + prodln + "]' id='product_name" + prodln + "' value='' title=''>";
...
function insertGroup()
{
  ...
  footer_cell.innerHTML="<input type='button' tabindex='116' class='button add_product_line' value='"+SUGAR.language.get(module_sugar_grp1, 'LBL_ADD_PRODUCT_LINE')+"' id='"+productTable.id+"addProductLine' onclick='insert(\""+productTable.id+"\",\""+groupn+"\")' />";
