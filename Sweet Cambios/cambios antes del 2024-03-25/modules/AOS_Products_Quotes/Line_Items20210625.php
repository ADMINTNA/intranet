        ...
        while ($row = $focus->db->fetchByAssoc($result)) {
            ...
            if ($line_item->product_id != '0' && $line_item->product_id != null) {
                if ($productCount == 0) {
                    ...
                    $product .= "<td width='6%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>&nbsp;&nbsp;<b>Vigencia</b></td>";

                  	$product .= "<td width='9%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>Fecha Contrato</b></td>";
 					
					
                    $product .= "<td width='12%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>".$mod_strings['LBL_LIST_PRICE']."</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                    $product .= "<td width='6%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>".$mod_strings['LBL_DISCOUNT_AMT']."</b></td>";
                    $product .= "<td width='12%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>".$mod_strings['LBL_UNIT_PRICE']."</b></td>";
                   // $product .= "<td width='12%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT']."</td>";
                   $product .= "<td width='9%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>Costo</b></td>";
                   //  $product .= "<td width='12%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT_AMT']."</td>";
                    $product .= "<td width='12%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>".$mod_strings['LBL_TOTAL_PRICE']."</b></td>";
                    $product .= "</tr>";
                }
                ...
                $product .= "<td class='tabDetailViewDF' style='text-align: center; padding:2px;'>".$line_item->duracion_contrato."</td>";
