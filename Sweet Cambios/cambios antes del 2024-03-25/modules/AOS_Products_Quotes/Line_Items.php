    ...
    if ($view == 'EditView') {
        ...
        while ($row = $focus->db->fetchByAssoc($result)) {
            ...
            if ($enable_groups && ($group_id != $row['group_id'] || $i == 0)) {
                ...
                $grupo_nombre = "<b><i>".$mod_strings['LBL_GROUP_NAME'].": ".$group_item->name."</i></b>";
                
                $groupStart .= "<tr>";
               // $groupStart .= "<td class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'>&nbsp;</td>";
              //  $groupStart .= "<td colspan='3' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'><n>".$mod_strings['LBL_GROUP_NAME'].":</n></td>";
                $groupStart .= "<td colspan='3' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'>".$grupo_nombre.":</td>";
                //$groupStart .= "<td class='tabDetailViewDL' colspan='7' style='text-align: left;padding:2px;'><i><n>".$group_item->name."</n></i></td>";
                $groupStart .= "</tr>";
            ...
            if ($line_item->product_id != '0' && $line_item->product_id != null) {
                if ($productCount == 0) {
                    $product .= "<tr>";
                    $product .= "<td width='1%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'><b>#</b></td>";
                    $product .= "<td width='1%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'><b>".substr($mod_strings['LBL_PRODUCT_QUANITY'],0,4)."</b></td>";
                    $product .= "<td width='20%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'><b>".$mod_strings['LBL_PRODUCT_NAME']."</b></td>";
                    $product .= "<td width='12%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'><b>Proveedor</b></td>";
                    $product .= "<td width='15%' class='tabDetailViewDL' style='text-align: left;padding:2px;' scope='row'><b>Codigo de Servicio</b></td>";
                    $product .= "<td width='5%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>&nbsp;&nbsp;<b>Vigencia</b></td>";

                  	$product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>Fecha Contrato</b></td>";
 					
					
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>".$mod_strings['LBL_LIST_PRICE']."</b>&nbsp;&nbsp;&nbsp;&nbsp;</td>";
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>".$mod_strings['LBL_DISCOUNT_AMT']."</b></td>";
                    $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>".$mod_strings['LBL_UNIT_PRICE']."</b></td>";
                   // $product .= "<td width='12%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT']."</td>";
                   $product .= "<td width='8%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>Costo</b></td>";
                   //  $product .= "<td width='12%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'>".$mod_strings['LBL_VAT_AMT']."</td>";
                    $product .= "<td width='10%' class='tabDetailViewDL' style='text-align: right;padding:2px;' scope='row'><b>".$mod_strings['LBL_TOTAL_PRICE']."</b></td>";
                    $product .= "</tr>";
                }
                ...
                $product .= "<td class='tabDetailViewDF' style='padding:2px; text-align: left;'>&nbsp;&nbsp;&nbsp;&nbsp;".stripDecimalPointsAndTrailingZeroes(format_number($line_item->product_qty), $sep[1])."</td>";
                ...
                $product .= "<td class='tabDetailViewDF' style='text-align: left; padding:2px;'>".ucwords(strtolower($line_item->account_name))."</td>";
                 $product .= "<td class='tabDetailViewDF' style='text-align: left; padding:2px;'>".$line_item->codigo_servicio."</td>";
                $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".$line_item->duracion_contrato."</td>";
                $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".$line_item->fecha_contrato."</td>";
