...
/* 21-10-2020 MAO: se renombra por reemplazo https://www.easycron.com/cron-job-tutorials/how-to-set-up-cron-job-for-suitecrm

if (substr($sapi_type, 0, 3) != 'cli') {
    sugar_die("cron.php is CLI only.");
}
*/
 // se incrusta este codigo
//---------  comienzo de codigo incrustado
