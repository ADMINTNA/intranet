...
class SugarWidgetFieldName extends SugarWidgetFieldVarchar
{
    ...
    public function queryFilterone_of(&$layout_def, $rename_columns = true)
    {
        ...
        $str = implode(",", $arr);
/* 23-10-2020 MAO se comenta llamada afuncion deprecated 
 PHP Deprecated:  Non-static method SugarWidgetReportField::_get_column_select() should not be called statically in /home/tnasolut/public_html/intranet/sweet/include/generic/SugarWidgets/SugarWidgetFieldname.php on line 244
