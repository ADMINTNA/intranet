    ...
    if ($view == 'EditView') {
        ...
        while ($row = $focus->db->fetchByAssoc($result)) {
            ...
            if ($line_item->product_id != '0' && $line_item->product_id != null) {
                ...
                $product .= "<td class='tabDetailViewDF' style='text-align: left; padding:2px;'>".ucwords(strtolower($line_item->proveedor_name_c))."</td>";
                $product .= "<td class='tabDetailViewDF' style='text-align: center; padding:2px;'>".$line_item->duracion_c."</td>";
                $product .= "<td class='tabDetailViewDF' style='text-align: right; padding:2px;'>".$line_item->fecha_contrato_c."</td>";
