...
function insertProductLine(tableid, groupid) {
  ...
  h1w.innerHTML += "<input class='sqsEnabled product_name' autocomplete='on' type='text' name='product_proveedor_name_c[" + prodln + "]' id='product_proveedor_name_c" + prodln + "' value='' title=''><input type='hidden' name='product_account_id_c[" + prodln + "]' id='product_account_id_c" + prodln + "'  maxlength='50' value=''>" ;
  ...
  h2w.innerHTML+= "<input  type='text' name='product_duracion_c[" + prodln + "]' id='product_duracion_c" + prodln + "' />" ;
  ...
  //h3w.innerHTML += "<input type='text' name='product_fecha_contrato_c" + prodln + "' id='product_fecha_contrato_c" + prodln + "' /> ";
   h3w.innerHTML += "<input class='date_input' autocomplete='on' type='text' name='product_fecha_contrato_c[" + prodln + "]' id='product_fecha_contrato_c" + prodln + "' /> ";
 ...
 function openProviderPopup(ln){
  ...
  var popupRequestData = {
    ...
    "field_to_name_array" : {
      ...
      "name" : "product_proveedor_name_c" + ln,
    }
  };
