                            ...
                            <table border="0" align="center">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>Usuario Nombre<br></td>
                                  <td><input name="u_nombre" type="text" id="u_nombre" size="20" value=""></td>
                                </tr>
                                <tr>
                                  <td align="center">3</td>
                                  <td>Usuario Apellido<br></td>
                                  <td><input name="u_apellido" type="text" id="u_apellido" size="20" value=""></td>
                                </tr>
                                <tr>
                                  <td align="center">3</td>
