...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
 ...
 <head>
  <title>Tareas iContel Telecomunicaciones</title>
   <style type="text/css">
   	html, body, div {
   		margin:0;
   		padding:0;
        ...
        <tr align="center" style="color: white;background-color: #1F1D3E;">
          ...
          <td>
              <table width="100%" height="100%">
                  <tr height="90">
                      <th align="center" style="font-size: 20px;">Buscador de Tareas  en Sweet</th>
                  </tr>
                  <tr>
                      <td align="center" style="font-size: 12px;">(click sobre los títulos de las Columnas para ordenar)</td>
                  </tr>
              </table>
          </td>    
        </tr>
