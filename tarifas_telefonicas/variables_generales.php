<?php
	...
	#es: Define si phpMyDataGrid ocupará automáticamente o no el ancho disponible en pantalla
	$objGrid -> liquidTable = true;	
	#es: Complementa a la propiedad liquidTable definiendo el porcentaje de pantalla que ocupará automáticamente
	$objGrid -> width = "100%";
	#es: CEspecifica el ancho de los iconos usados como botones
