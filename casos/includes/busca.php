...
$tmp = busca_casos_creados("P4");
$tmp = busca_casos_creados("P5");
  ...
  switch($periodo) {
      ...
      case "1a":
       ...
       // $sql = "CALL searchcasescreatedbyhours('8760')";       
        break;
      case "P4":
        $sql = "CALL searchcasesenseguimiento()";       
       // $sql = "CALL searchcasescreatedbyhours('8760')";       
        break;
      case "P5":
        $sql = "CALL searchcasescongelado()";       
       // $sql = "CALL searchcasescreatedbyhours('8760')";       
        break;
      default:
    } 
    // me conecto a la Base de Datos
    $conn = DbConnect1("tnasolut_sweet");
    ...
    if ($result->num_rows > 0)   { 
        ...
        $linea ="document.getElementById('total".$periodo."').innerHTML = '";
        if($periodo == "a") $linea .= $total_abierto."'"; else $linea .= $total."'"; 
        echo '<script type="text/javascript">';
        echo $linea;   
        echo '</script>';
