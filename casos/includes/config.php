...
//////// Funciones //////////////
function DbConnect1($dbname){ // se conecta a base de datos y devuelve $conn
	$server   =  "localhost";
    $user     = "data_studio";
    $password = "1Ngr3s0.,"; 
...
function get_aos_product_quotes1($id) { // devuelve datos del aos_product_quotes buscado por id
...
function contactos_cuenta1($id) { // devuelve select con los contactos de la cuenta
   // global $account_id, $ani; $contacto;
     // me conecto a la Base de Datos
    $conn = DbConnect("tnasolut_sweet");
