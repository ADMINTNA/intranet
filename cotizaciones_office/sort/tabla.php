...
$sql = "
SELECT 
	CONCAT('https://sweet.tnaoffice.cl/index.php?module=AOS_Quotes&action=DetailView&record=',aq.id) as url_coti,
    CONCAT('https://sweet.tnaoffice.cl/index.php?module=Opportunities&action=DetailView&record=', op.id) AS url_op,
    aq.id AS cot_id,
