...
<?php if (!empty($quotes)): ?>
    <table style="margin: 0 auto; border-collapse: collapse; width: 90%; text-align: center; border: 1px solid #ddd;">
        <tr style="background-color: #f2f2f2;">
            <th>#</th><th>NÂº</th><th style="text-align: left;">TÃ­tulo</th><th>CreaciÃ³n</th>
            <th>Moneda</th><th>Monto</th><th>Estado</th><th>Usuario</th><th>Op NÂº</th><th>Estado OP</th>
        </tr>
...
<h2 style="text-align: center;">GrÃ¡fico de Cotizaciones Por Estado</h2>    
<!-- GrÃ¡fico -->
<!-- Contenedor para el grÃ¡fico con ancho de 800px -->
