...
// Preparar y ejecutar la consulta con los parÃ¡metros dolar y uf
$resumen_stmt = $pdo->prepare($resumen_sql);
$resumen_stmt->bindParam(':start_date', $start_date);
$resumen_stmt->bindParam(':end_date', $end_date);
$resumen_stmt->bindParam(':dolar', $dolar); // ParÃ¡metro dolar
$resumen_stmt->bindParam(':uf', $uf);       // ParÃ¡metro uf
    ...
    <table align="center">
        ...
        foreach ($quotes as $quote): ?>
            <tr>
                ...
                <td><?= htmlspecialchars($quote['nombre']); ?></td> <!-- Mostrar el campo nombre aquÃ­ -->
