...
function getConnection() {
    ...
    try {
        ...
        $pdo->setAttribute(PDO::MYSQL_ATTR_USE_BUFFERED_QUERY, true); // Habilitar el almacenamiento en bÃºfer de consultas
...
$selected_user = '';
$selected_estado = '';
$excluir_op_gd = true; // Variable para el checkbox de exclusiÃ³n
...
$stmt->closeCursor(); // Cerrar el cursor para liberar la conexiÃ³n
...
// Obtener lista de usuarios y estados Ãºnicos del recorset filtrado
