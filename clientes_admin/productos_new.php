<?php
	...
	$objGrid-> searchby("estadoprod, producto, dir_inst, codigo_servicio, proveedor, comentarios ");
	...
	$objGrid-> tituloGrid("Detalle de productos por cliente");
...
//////////////////////////////////////////////////////////////////////////
	...
	$objGrid -> FormatColumn("rut","RUT", "13", "13", "0", "90", "right", "text", $rut); 
	$objGrid -> FormatColumn("estadoprod", "Estado",  30, 30, 0, "80", "left", "select:En Instalacion:Activo:Suspendido:Sin Cliente:De Baja:En Traslado:Trasladado:Gasto","Activo");

	$objGrid -> FormatColumn("proveedor", "Proveedor",  30, 30, 0, "150", "left", "select:Telefonica Empresas:Telefonica Chile:Telefonica Mayorista:Airpoint:Claro:PIT Chile:TNA Phone:Silica:Bynarya:TNA Solutions:GTD Teleductos:GTD Lidice II:GTD Manquehue:Entel:Cmet:ifx:Cogen:EdgeUno:UFINET:infomagia:3CX:TNA Office:DIDWW:Lidice II:NIC Chile","telefonica empresas");

	$objGrid -> FormatColumn("producto", "Producto",  25, 25, 0, "100", "center", "select:ADSL:Enlace Dedicado:Punto a Punto:Ultima Milla Capa 2:Ultima Milla Capa 3:VLan:Router:X conect:MB internacional:Boca Switch:Plan Telefonia IP:Hosting:Soporte:Cloud:VPN:PACK IP:VPS:Colocate:DID Adicional:Equipo en Comodato:Equipo en Arriendo:MPLS:Canje:Gasto:SMS:Siptrunk:Licencia:Otros telefonia ip:Publicacion ASN:IPTV", "Enlace Dedicado");
	...
	$objGrid -> FormatColumn("vendedor", "Vendedor",  20, 20, 0, "80", "right", "select:DAM:MAM:MAO:romina:angel","romina");
	...
	$objGrid -> addCellStyle ("estadoprod", "['estadoprod']=='en instalacion'", "colornaranjo");
