...
//	$objGrid -> width = "100%";
	...
	$objGrid-> searchby("homologado, nombre, rut, estado, direccion, comuna, ciudad, fono, celular, email, contacto_nombre, contacto_email");
...
//////////////////////////////////////////////////////////////////////////
    ...
    $objGrid-> FormatColumn("homologado","Check", "13", "1", 0, "60", "center", "check:No:OK");
	$objGrid -> FormatColumn("rut", "R.U.T.", 13, 13, 0, "80", "right"," ");
	$objGrid -> FormatColumn("estado", "Estado",  30, 30, 0, "80", "left", "select:Activo:De Baja:Suspendido:Extra Judicial","Activo");
    $objGrid -> FormatColumn("nombre", "Nombre Completo", 150, 150, 0, "250", "left"," ");
    $objGrid -> FormatColumn("relacionada", "Empresa Relacionada", 150, 150, 0, "250", "left"," ");
	$objGrid -> FormatColumn("ejecutivo", "Ejecutiv@",  30, 30, 0, "150", "left", "select:DAM:MAM:MAO:Romina:Angel","DAM");
