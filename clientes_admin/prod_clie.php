...
$producto = "enlace dedicado";
	...
	$objGrid = new datagrid('prod_clie.php','2');
...
//	$objGrid -> ButtonWidth = '100';
	...
	$objGrid-> searchby("estadoprod, nombre, clase_modelo, costo_UF, valor_UF, costo_vigente_uf, valor_vigente_uf, Tipo_Pago, dir_inst");
...
//	$objGrid-> buttons(false,true,false,false);
	...
	$objGrid-> FormatColumn("dir_inst","Direccion de Instalacion", "150", "150", 0, "150","right");
