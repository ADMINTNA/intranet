...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table width="100%" border='0' style='border-collapse: collapse;' id="eventos">
		<tr>
		  <td colspan=8 align="left" bgcolor="#15163C" scope="row"><h4>&nbsp; #somostnasolutions</h4></td>
		</tr>
		<tr>
		  <td colspan=8 align="left" bgcolor="#CF6F2A" scope="row"><h5>&nbsp;TRABAJANDO JUNTOS PARA DAR EL MEJOR SERVICIO !!</h5></td>
		</tr>
		<tr>
		  <td colspan=8 align="left" bgcolor="#FFFFFF" scope="row"><img src="/eventos/images/LOGO_CO9LOR-1 (1).png" width="" height="90" alt=""/></td>
		</tr>
		<tr>
