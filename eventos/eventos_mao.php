...
.contenedor{
  ...
  margin: 1% 1%;
	...
	iframe { display:block; width:100%; height: 350px;  border:none; }
...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table width="100%" border='0' style='border-collapse: collapse;'>
		<tr>
		  <td colspan=8 align="left" bgcolor="#15163C" scope="row"><h3>&nbsp; #somostnasolutions</h3></td>
		</tr>
		<tr>
		  <td colspan=8 align="left" bgcolor="#CF6F2A" scope="row"><h3>&nbsp;TRABAJANDO JUNTOS PARA DAR EL MEJOR SERVICIO !!</h3></td>
		</tr>
		<tr>
		  <td colspan=8 align="left" bgcolor="#FFFFFF" scope="row"><img src="images/LOGO_CO9LOR-1 (1).png" width="360" height="105" alt=""/></td>
		</tr>
		<tr>
		  <td  height="4" colspan=8  align="left" bgcolor="#15163C" scope="row"></td>
		</tr>		
		<tr align='center'>
		  <th bgcolor="#15173C" align='center'><a href='mantencion.php'>#</a></th>
		  ...
		  <td bgcolor="#15173C" rowspan='9' align='center' ><div id='grafico'>aqui<br>va<br>el<br>gráfico</div></td>
		</tr>
<?php
	$iframe = ".php";
