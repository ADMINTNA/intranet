...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
	<table border='0' id="eventos">
		...
		<tr>
		  <td colspan="5" align="left" bgcolor="#FFFFFF" scope="row"><img src="/eventos/images/logo_icontel_no_bg.png" width="" height="200" alt=""/></td>
		</tr>
		<tr>
        ...
        <?php
            ...
            while($row = mysqli_fetch_row($result)) {
                ...
                <?PHP } // fin while ?> 
                <tr>
                    <td height="5"  bgcolor="#CF6F29" colspan=7 align='center' >Nota: Datos de Monitoreo desde el 01/01/2021 00:00:00 Hrs.(Hace <?PHP echo $diff->days . ' dias'; ?>)</td>
                </tr>
                <tr>
