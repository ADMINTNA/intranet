<?php include_once("session.php"); 
	//print_r($_SESSION);
	$exit = 0;
	if($_SESSION["id"]<>1 && $_SESSION["id"]<>15 && $_SESSION["id"]<>17 && $_SESSION["id"]<>32) {$exit = 1;} // DAM, MAO o Alex	
?>
...
<?PHP 
	if(!$exit){
		echo "<iframe src='eventos_man.php' ></iframe>";
	} else {
		echo "UPS.... Ocurri&oacute; algún problema [".$_SESSION["id"]."].<br />
		<br />
		Favor comunicarse con soporte TNA, datos en el footer de esta p&aacute;gina.<br />
		<br />
		Gracias";
	}
?>	
