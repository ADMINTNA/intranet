<?php 
   ...
   //$contacto = strtolower($nombre)." ".strtolower($apellido);
    ...
    $id         = "";
    $no_mostrar = 0;
    $url        = 'https://sweet.icontel.cl/index.php?action=ajaxui#ajaxUILoc=index.php%3Fmodule%3DAccounts%26offset%3D4%26stamp%3D1642464369091709700%26return_module%3DAccounts%26action%3DDetailView%26record%3D'; 
