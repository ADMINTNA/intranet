...
$url_nueva_tarea = "https://sweet.tnaoffice.cl/index.php?module=Tasks&action=EditView"; // Assuming a default URL for new task
...
<style>
/* Fix para fondo de filas (evitar herencia de header) */
#tareas tbody tr { background-color: #ffffff; }
#tareas tbody tr:nth-child(odd) { background-color: #F6F9FA; }
</style>
